...
namespace GUI
{
    public partial class urcDanhSachNhanVien : UserControl
    {
        ...
        private clsNhanVien_DTO TaoDoiTuongNhanVien()
        {
            ...
            ngayThoiViec = (cboTrangThai.SelectedIndex == 1 ? DateTime.Now : nullDateTime);

            string maChucVu = cboChucVu.SelectedValue.ToString().Trim();
            int trangThai = (cboTrangThai.SelectedIndex > 0 ? cboTrangThai.SelectedIndex : 1);

            return utl.TaoDoiTuongNhanVien(ma, hoTen, anh, ngaySinh, gioiTinh, diaChi, sdt, ngayBatDauLam, maChucVu, trangThai);
        }
        ...
        private void dgvDSNV_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            foreach (DataGridViewRow r in dgvDSNV.Rows)
            {
                ...
                else if (Convert.ToInt32(r.Cells["colTrangThai"].Value) == 3) // Đang chờ phê duyệt vào làm
        ...
        private void dtpNgayThoiViec_ValueChanged_1(object sender, EventArgs e)
        {
        ...
        private void TimKiemNhanVien()
        {
            ...
            List<clsNhanVien_DTO> lstNhanVien = bus.TimKiemNhanVien(hoTen, maChucVu, gioiTinh, trangThai);
            dgvDSNV.AutoGenerateColumns = false;
            dgvDSNV.DataSource = lstNhanVien;
        }
