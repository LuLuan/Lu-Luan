...
namespace GUI
{
  public class ThaoTacChung
  {
    ...
    //public string BTCQMatKhau = @"^((?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[_|*|@])([a-zA-Z0-9*_@]){5,20})$";
    //public string BTCQMaKhanCap = @"^(([0-9]){6,6})$";
    //public string BTCQHoTen = @"^((?!.*[\`|\~|\!|\@|\#|\$|\%|\^|\&|\*|\(|\)|\+|\=|\[|\{|\]|\}|\||\\|\'|\<|\,|\.|\>|\?|\/|\""|\;|\:])(?!.*[\d]).{5,50})$";
    //public string BTCQSoDienThoai = @"^(([0-9]){10,13})$";
    //public string BTCQDiaChi = @"^((?!.*[\`|\~|\!|\@|\#|\$|\%|\^|\&|\*|\+|\=|\[|\{|\]|\}|\||\\|\'|\<|\>|\?|\""|\;|\:]).{15,250})$";
